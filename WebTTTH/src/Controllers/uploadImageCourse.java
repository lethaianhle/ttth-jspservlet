...
public class uploadImageCourse extends HttpServlet {
    ...
    private static final String UPLOAD_DIRECTORY = "images"+File.separator+"course";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(usname == null) {
	            ...
	            if (formItems != null && formItems.size() > 0) {
	                ...
	                for (FileItem item : formItems) {
	                    ...
	                    if (!item.isFormField()) {
	                        ...
	                        boolean flag = editCourseDAO.UpdateImage(IDupload, ava, conn);
	                        if(flag==true) {
	        ...
	        course c = new course();
			c = loadCourseDAO.LoadCourseInfo(IDupload, conn);
