							...
							<div id="footerlst2" class="widget2">
								<h3 class="titlefooter2">Contact</h3>
									<div  style="padding-top: 17px;">
										<ul class="textwidget">
											<li style="font-size: 14px;"><i class="fa fa-map-marker" style="font-size:20px;color:rgba(230, 226, 226, 0.84);"></i>&nbsp;&nbsp;Số 1, Thanh Xuân, Hà Nội</li>
			...
			<div class="footer2-bottom">
				<div class="container">
					<div class="footer2-center">
						© Copyright 2017. All Rights Reserved</br>Powered and Designed by Nhóm 6
					</div>
				</div>
			</div>
		</div>
